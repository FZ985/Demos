 ...
 * description :
 */
public class AppCompatWrapTextView extends AppCompatTextView {
    ...
    public AppCompatWrapTextView(@NonNull Context context) {
        super(context);
        init();
    }

    public AppCompatWrapTextView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public AppCompatWrapTextView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
