...
public abstract class DownLoadStatusCallbackAdapter<T> implements
	...
	public void onProgress(T bean, long currentSize) {
		if (bean != null) {
			Log.e("download","#下载进度#" + currentSize);
		}
	}
